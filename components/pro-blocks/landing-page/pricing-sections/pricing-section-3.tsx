  ...
  plans: [
    {
      ...
      features: [
        { name: "Product planning guidance", tooltip: "A practical starting point for your product direction" },
        {
          name: "Architecture direction",
          tooltip: "Practical technical guidance for early product decisions",
        },
        { name: "Launch-ready roadmap", tooltip: "A focused path from concept to next build step" },
      ],
      price: 0,
      period: "/month",
      variant: "outline",
    },
    {
      ...
      description:
        "A short benefit statement that highlights the ideal user for this tier.",
      features: [
        { name: "Product engineering", tooltip: "Build the core application with senior engineers" },
        { name: "Scalable architecture", tooltip: "Foundations designed for growth and change" },
        { name: "AI and automation", tooltip: "Intelligent systems connected to real workflows" },
        { name: "Mobile and enterprise", tooltip: "Extend your product across the channels that matter" },
        { name: "Launch support", tooltip: "Stay supported through release and iteration" },
      ],
      price: 15,
      period: "/user/month",
      variant: "default",
