              ...
              >
                ...
                <AccordionItem value="item-1">
                  <AccordionTrigger className="text-left">
                    How does Priworth join my meetings?
                  </AccordionTrigger>
                  <AccordionContent>
                    Priworth automatically joins your scheduled meetings
                    through calendar integration. Simply connect your calendar
                    (Google Calendar, Outlook, etc.) and Priworth will join
                    meetings at the scheduled time. You can also manually invite
                    Priworth to any meeting by adding our bot email to your
                ...
                <AccordionItem value="item-2">
                  <AccordionTrigger className="text-left">
                    What languages does Priworth support?
                  </AccordionTrigger>
                  <AccordionContent>
                    Priworth currently supports English, Spanish, French,
